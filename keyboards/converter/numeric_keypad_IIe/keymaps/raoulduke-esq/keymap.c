...
*/
  ...
  [1] = LAYOUT(
    RESET,      KC_MPRV,    KC_MPLY,      KC_MNXT,       KC_BSPC,        KC_DEL, \
    KC_UP,      KC_HOME,    KC_PGUP,      KC_PAUSE,      KC__VOLUP,      LGUI(KC_0), \
    KC_DOWN,    KC_END,     KC_PGDN,      KC_SLCK,       KC__MUTE,       HYPR(KC_M), \
    KC_TRNS,    LGUI(KC_T), LGUI(KC_W),   SGUI(LOPT(KC_V)), KC__VOLDOWN,    KC_TRNS  \
  ),
};
