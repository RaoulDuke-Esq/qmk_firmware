...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[0] = LAYOUT_ansi(
	       ...
	       LT(1, KC_TAB),  KC_Q,    KC_W, KC_E, KC_R, KC_T,   KC_Y, KC_U, KC_I,    KC_O,   KC_P,             KC_LBRC, KC_RBRC,           KC_P7,   KC_P8,  KC_P9,   KC_PMNS, \
	       MO(1),          KC_A,    KC_S, KC_D, KC_F, KC_G,   KC_H, KC_J, KC_K,    KC_L,   KC_SCLN,          KC_QUOT,          KC_ENT,   KC_P4,   KC_P5,  KC_P6,   KC_PPLS, \
	       KC_LSFT,        KC_Z,    KC_X, KC_C, KC_V, KC_B,   KC_N, KC_M, KC_COMM, KC_DOT, KC_SLSH,                            KC_PSLS,  KC_P1,   KC_P2,  KC_P3,   KC_PENT, \
	       KC_LCTL, KC_LGUI,                   KC_SPC,                      KC_LALT,  KC_NO,                 KC_PSLS, KC_PAST, KC_PEQL,  KC_P0,           KC_PDOT),
	...
	[1] = LAYOUT_ansi(
		   ...
		   KC_TRNS,  KC_HOME, KC_UP,   KC_PGUP, RESET, KC_NO, KC_NO, KC_NO, KC_PSCR, KC_SLCK, KC_PAUS, KC_UP,   KC_INS,          KC_HOME, KC_P8,  KC_PGUP, KC_PMNS, \
		   KC_TRNS, KC_LEFT, KC_DOWN, KC_RGHT, KC_NO, KC_NO, KC_NO, KC_NO, KC_HOME, KC_PGUP, KC_LEFT, KC_RGHT,         KC_ENT,   KC_P4,   KC_P5,  KC_P6,   KC_PPLS, \
		   KC_TRNS, KC_END,  KC_NO,   KC_PGDN, KC_NO, KC_NO, KC_NO, KC_NO, KC_END,  KC_PGDN, KC_DOWN,                  KC_UP,    KC_END,  KC_P2,  KC_PGDN, KC_PENT, \
	       KC_TRNS, KC_LGUI,                          KC_SPC,                       KC_TRNS, KC_TRNS, KC_LEFT, KC_RGHT, KC_DOWN, KC_P0,           KC_PDOT),
